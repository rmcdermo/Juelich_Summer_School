...
The resolved kinetic energy $K$ covers the part up to a wave number of $k_{\text{Nq}}$, while $k_{\text{sgs}}$ represents the unresolved part of the kinetic energy.
...
| $\sf{Cell\ ID}$ | $\rho \, (\mathrm{kg/m^3})$ | $u \, (\mathrm{m/s})$ |
| ---- | --------------- | --------- |
| 1    | 1.0             | 10.0      |
| 2    | 10.0            | 1.0       |
| 3    | 1.0             | 10.0      |

<!-- | $\sf{Cell ID}$ | $\rho \,/\, (\mathrm{kg/m^3})$ | $u \,/\, (\mathrm{m/s})$ | $\rho\,u \,/\,(\mathrm{kg/m^2/s})$ |
| ---- | --------------- | --------- | ------------------- |
| 1    | 1.0             | 10.0      | 10.0                |
| 2    | 10.0            | 1.0       | 10.0                |
| 3    | 1.0             | 10.0      | 10.0                | -->
...
1. $(\rho\cdot u)_i = 10\,\mathrm{kg/m/s}$
1. - $\bar{u} = 21/3\,\mathrm{m/s} = 7\,\mathrm{m/s}$
   - $\bar{\rho} = 12/3\,\mathrm{kg/m^3} = 4\,\mathrm{kg/m^3}$
1. - $\overline{\rho\cdot u} = 10\,\mathrm{kg/m/s}$
   - $\bar{\rho}\cdot\bar{u} = 28\,\mathrm{kg/m/s}$
   - $\overline{\rho\cdot u} \neq \bar{\rho}\cdot\bar{u}$
1. - $\tilde{u} = 10 / 4\,\mathrm{kg/m/s} = 2.5\,\mathrm{kg/m/s}$
   - $\bar{\rho}\cdot\tilde{u} = 4 \cdot 2.5\,\mathrm{kg/m/s} = 10\,\mathrm{kg/m/s}$
