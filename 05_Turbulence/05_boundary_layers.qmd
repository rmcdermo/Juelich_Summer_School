...
The Prandtl number (Pr) is defined as the ratio of momentum to thermal diffussivity: 
...
0.54 \, \text{Ra}^{1/4} & \text{Horizontal hot plate facing up or cold plate facing down, } \text{Ra} \leq 10^7 \\
0.15 \, \text{Ra}^{1/3} & \text{Horizontal hot plate facing up or cold plate facing down, } \text{Ra} > 10^7 \\
0.52 \, \text{Ra}^{1/5} & \text{Horizontal hot plate facing down or cold plate facing up} \\
