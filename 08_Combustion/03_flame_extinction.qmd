...
::: {.ext-plot-overlay}
![](figs/flame_extinction/extinction_1.png){.ext-plot-page width=560 height=560 fig-alt="Extinction Model 1: verification results"}

::: {.ext-temperature-arrow .ext-free-arrow aria-hidden="true"}
:::
::: {.ext-temperature-label .ext-free-label}
FREE_BURN_TEMPERATURE
:::
:::
:::
::: {.ext-panel}
...
::: {.ext-plot-overlay}
![](figs/flame_extinction/extinction_2.png){.ext-plot-page width=560 height=560 fig-alt="Extinction Model 2: verification results"}

::: {.ext-temperature-arrow .ext-critical-arrow aria-hidden="true"}
:::
::: {.ext-temperature-label .ext-critical-label}
...
::: {.ext-source}
See [FDS manuals](https://pages.nist.gov/fds-smv/manuals.html), User Guide, “Extinction.”
:::
...
:::
::: {.ext-pocket-field}
![](figs/flame_extinction/stoichiometric-pocket-field.png){fig-alt="Grayscale field with the original red hand-drawn markings identifying stoichiometric pockets."}
:::
:::
...
::: {.ext-green-box .ext-criterion-box}
$$
m_{\mathrm F}h_{s,\mathrm F}(T_0)+m_{\mathrm A}h_{s,\mathrm A}(T_0)
+m_{\mathrm D}h_{s,\mathrm D}(T_0)+Q
