...
<svg viewBox="0 0 160 72" role="img" focusable="false">
  <defs>
    <marker id="heat-release-rate-arrowhead" markerWidth="9" markerHeight="9" refX="8" refY="4.5" orient="auto" markerUnits="strokeWidth">
      <path d="M 0 0 L 9 4.5 L 0 9 Z"></path>
    </marker>
  </defs>
  <line x1="4" y1="4" x2="150" y2="66" marker-end="url(#heat-release-rate-arrowhead)"></line>
</svg>
...
<svg viewBox="0 0 100 24" role="img" focusable="false">
  <path d="M0 10H78V2L100 12L78 22V14H0Z"></path>
</svg>
...
<svg viewBox="0 0 24 100" role="img" focusable="false">
  <path d="M10 0H14V78H22L12 100L2 78H10Z"></path>
</svg>
...
<svg viewBox="0 0 24 100" role="img" focusable="false">
  <path d="M12 0L22 22H14V100H10V22H2Z"></path>
</svg>
...
<pre class="hoc-console-output"><span class="hoc-console-prompt">In [42]:</span> run HOC.py
HOC Fuel Basis: 4.630e+07
HOC O2 Basis:   1.276e+07</pre>
