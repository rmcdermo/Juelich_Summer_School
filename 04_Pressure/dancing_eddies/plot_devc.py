...
#     i=1 : pressure
#     i=2 : maximum velocity error
#     i=3 : pressure iterations
#     i=4 : CPU time
#     i=5 : scarc iterations                  (only available for scarc and uscarc-solvers)
#     i=6 : scarc residual                    (only available for scarc and uscarc-solvers)
