...
| Superbee (*LES default) | max(0, min(2r,1), min(r,2)) | loc | SUPERBEE |
| MINMOD | max(0, min(1,r)) | loc | MINMOD |
| CHARM (DNS default) | $\left(3\frac{1}{r}+1\right) / \left(r(\frac{1}{r}+1)^2\right)$ | up | CHARM |

## Example 6 -- Scalar transport with FDS

**Input directory**: [06_fds_flux_limiter](./exercises/06_fds_flux_limiter)
...
- Still, fluctuations in density enforce correction methods.
